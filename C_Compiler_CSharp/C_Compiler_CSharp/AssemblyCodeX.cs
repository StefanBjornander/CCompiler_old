...
namespace CCompiler {
  public class AssemblyCode {
    ...
    public List<byte> ByteList() {
      ...
      else if ((operand1 is int) && (operand0 is string) && (operand2 is Register)) { // mov [global + 4], ax
      ...
      else if ((operand1 is int) && (operand0 == null) && (operand2 is Register)) { // mov [null + 4], ax
        Register fromRegister = (Register) operand2;
        int offset = (int) operand1;
        int size = SizeOfUnsignedValue(offset);
        List<byte> byteList = LookupByteArray(m_operator, null, Type.PointerSize, fromRegister);
        LoadByteList(byteList, byteList.Count - Type.PointerSize, Type.PointerSize, offset);
        return byteList; 
      }
      ...
      else if ((operand1 is int) && (operand0 is string) && (operand2 is BigInteger)) { // mov [global + 4], 123
        int offset = (int) operand1, value = (int) ((BigInteger) operand2);
      ...
      else if ((operand1 is int) && (operand0 == null) && (operand2 is BigInteger)) { // mov [null + 4], 123
        int offset = (int) operand1, value = (int) ((BigInteger) operand2);
        int valueSize = SizeOfSignedValue(value);
        List<byte> byteList = LookupByteArray(m_operator, null, Type.PointerSize, valueSize);
        LoadByteList(byteList, byteList.Count - (Type.PointerSize + valueSize), Type.PointerSize, offset);
      ...
      else if ((operand0 is string) && (operand0 is string) && (operand1 is int) && (operand2 is string)) { // mov [global + 4], global; mov [null + 4], global
        int offset = (int) operand1;
        int offsetSize = SizeOfSignedValue(offset);
        List<byte> byteList = LookupByteArray(m_operator, null, offsetSize, Type.PointerSize);
        LoadByteList(byteList, byteList.Count - (offsetSize + Type.PointerSize), offsetSize, offset);
        LoadByteList(byteList, byteList.Count - Type.PointerSize, Type.PointerSize, 0);
        return byteList; 
      }
      else if ((operand0 is string) && (operand0 == null) && (operand1 is int) && (operand2 is string)) { // mov [null + 4], global
        int offset = (int) operand1;
        int offsetSize = SizeOfUnsignedValue(offset);
        List<byte> byteList = LookupByteArray(m_operator, null, offsetSize, Type.PointerSize);
        LoadByteList(byteList, byteList.Count - (offsetSize + Type.PointerSize), offsetSize, offset);
        LoadByteList(byteList, byteList.Count - Type.PointerSize, Type.PointerSize, 0);
        return byteList; 
      ...
      else if ((operand0 is BigInteger) && (operand1 is string) && (operand2 is int)) { // cmp 123, [global + 4]
        int value = (int) ((BigInteger) operand0), offset = (int) operand2;
        int valueSize = SizeOfSignedValue(value), offsetSize = SizeOfSignedValue(offset);
      ...
      else if ((operand0 is BigInteger) && (operand1 == null) && (operand2 is int)) { // cmp 123, [null + 4]
        int value = (int) ((BigInteger) operand0), offset = (int) operand2;
        int valueSize = SizeOfSignedValue(value), offsetSize = SizeOfUnsignedValue(offset);
        List<byte> byteList = LookupByteArray(m_operator, valueSize, null, offsetSize);
        LoadByteList(byteList, byteList.Count - (valueSize + offsetSize), valueSize, value);
        LoadByteList(byteList, byteList.Count - offsetSize, offsetSize, offset);
        return byteList; 
      ...
      else if ((operand1 is int) && (operand0 is string)) { // inc [global + 4]; inc [null + 4]
        Assert.Error(operand2 == null);
        int offset = (int) operand1;
      ...
      else if ((operand0 == null) && (operand1 is int)) { // inc [global + 4]; inc [null + 4]
        Assert.Error(operand2 == null);
        int offset = (int) operand1;
        List<byte> byteList = LookupByteArray(m_operator, null, Type.PointerSize);
        LoadByteList(byteList, byteList.Count - Type.PointerSize, Type.PointerSize, offset);
