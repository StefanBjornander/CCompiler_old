...
namespace CCompiler {
  public class AssemblyCode {
    ...
    public static int SizeOfValueX(BigInteger value, AssemblyOperator? op = null) {
      string name = (op != null) ? Enum.GetName(typeof(AssemblyOperator), op.Value) : "";

      if (name.StartsWith("mov")) {
        return SizeOfOperator(op.Value);
      }
      else if (value == 0) {
        return name.StartsWith("cmp") ? Type.Bytes1 : Type.Bytes0;
      }
      else if ((-128 <= value) && (value <= 255)) {
        return Type.Bytes1;
      }
    ...
    public List<byte> ByteList() {
      ...
      /*else if ((operand1 is int) && (operand2 is Register)) { // mov [global + 4], ax; mov [null + 4], ax
        ...
        int offsetSize = SizeOfValue(offset),
            valueSize = SizeOfValue(value, m_operator);
        ...
        int valueSize = SizeOfValue(value, m_operator);
      ...
      /*else if ((operand0 is string) && (operand1 is int) && (operand2 is string)) { // mov [global + 4], global; mov [null + 4], global
        ...
        Assert.Error(false);
        BigInteger value = (BigInteger) operand0, offset = (int) operand2;
        int valueSize = SizeOfValue(value), offsetSize = SizeOfValue(offset);
        ...
        Register register = (Register) operand0;
        BigInteger value = (BigInteger) operand1;
        int size = ((m_operator == AssemblyOperator.mov) || (m_operator == AssemblyOperator.and))
      ...
      /*else if ((operand0 is BigInteger) && (operand1 is Register)) { // cmp 123, ax
        ...
        Assert.Error(operand2 == null);
        Register register = (Register) operand0; XXX
        int offset = (int) operand1;
        int size = SizeOfValue(offset);
        List<byte> byteList = LookupByteArray(m_operator, register, size);
        LoadByteList(byteList, byteList.Count - size, size, offset);
        ...
        if (m_operandArray[2] != null) {                  
          if (m_operandArray[1] is int) {
            ...
            // mov [register + integer}, not-null
              ...
              size2 = SizeOfValue((BigInteger) ((int) m_operandArray[1]));
            ...
            if ((m_operandArray[1] == null) ||
              ...
              operand3 = SizeOfValue((BigInteger) (int) m_operandArray[2]);
            ...
            // mov register, [register + integer]
              ...
              size3 = SizeOfValue((BigInteger) ((int) m_operandArray[2]));
              operand3 = size3;
              value3 = (BigInteger) ((int) m_operandArray[2]);
            }
            else {
          ...
          if (name.Contains("_") ||
            ...
            // inc_word [register + integer}
              ...
              operand1 = m_operandArray[0];
              operand2 = SizeOfValue((BigInteger) ((int) m_operandArray[1]));
              size2 = SizeOfValue((BigInteger) ((int) m_operandArray[1]));
              value2 = (BigInteger) ((int) m_operandArray[1]);
            }
            else {
            ...
            if (m_operandArray[1] is BigInteger) {
              if (m_operator == AssemblyOperator.mov) {
                ...
                size2 = SizeOfValue((BigInteger) m_operandArray[1]);
              }
          ...
          operand1 = SizeOfValue((BigInteger)  m_operandArray[0]);
          size1 = SizeOfValue((BigInteger) m_operandArray[0]);
    ...
    public override string ToString() {
      ...
      if ((m_operator == AssemblyOperator.empty) ||
        ...
        Register register = (Register) operand0;
        return "\tjmp" + register.ToString();
      }
      else if (IsCallNotRegister()) {
        string calleeName = (string) operand0;
        return "\tjmp" + calleeName;
      }
      else if (m_operator == AssemblyOperator.address_return) {
      }
      if (IsCallRegister() || IsCallNotRegister()) {
        return "\tjmp" + operand0.ToString();
      }
      else {
