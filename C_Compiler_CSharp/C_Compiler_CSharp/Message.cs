...
namespace CCompiler {
  public enum Message {
    ...
    Mixing_ellipse_function_parameter_in_redeclaration,
    Different_parameter_lists_in_function_redeclaration,
    Functions_cannot_be_initializerialized,
    Typedef_cannot_be_initializerialized,
    Extern_cannot_be_initializerialized,
    Struct_or_union_field_cannot_be_initializerialized,
    ...
    Unnamed_function_definitializerion,
    ...
    An_elliptic_function_must_have_at_least_one_parameter,
    ...
    Invalid_macro_definitializerion,
    Repeated_macro_parameter,
    Mixing_signed_and_unsigned_types,
    Invalid_macro_redefinitializerion,
    ...
    Unnamed_parameter,
    Unknown_register,
    Extern_enumeration_item_cannot_be_initializerialized,
